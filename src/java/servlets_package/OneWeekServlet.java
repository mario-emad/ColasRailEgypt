...
public class OneWeekServlet extends HttpServlet {
...
//            DATESTRING = DateTimeFormatter.ofPattern("yyy-MM-dd").format(localDate);
            ...
            c.add(Calendar.WEEK_OF_YEAR, 1);//==add one week into date.
